= On-Page Tutorials with amberjack

Amberjack is pretty darn usefull for creating on-page tutorials for your website.
See examples here: http://amberjack2.org/
...
* replaced "id"-selector for tour steps with a more general "element" selector now fully dependent on jQuery and its $()=>jQuery() selector
...
This is a clone of amberjack2 from http://amberjack2.org provided by Arash Yalpani. 
